...
export default class LineClient {
     ...
     */
    setWebhookEndpointUrl(endpoint: string): Promise<LineTypes.MutationSuccessResponse>;
    /**
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    broadcast(messages: LineTypes.Message[]): Promise<LineTypes.MutationSuccessResponse>;
    /**
     * Get Message Content
     *

...
class LineClient {
     ...
     */
    constructor(config) {
        (0, ts_invariant_1.default)(typeof config !== 'string', `LineClient: do not allow constructing client with ${config} string. Use object instead.`);
        ...
        this.dataAxios.interceptors.request.use((0, messaging_api_common_1.createRequestInterceptor)({ onRequest: this.onRequest }));
    }
    /**
     * @deprecated Use `new LineClient(...)` instead.
     */
    static connect(config) {
        (0, warning_1.default)(false, '`LineClient.connect(...)` is deprecated. Use `new LineClient(...)` instead.');
    ...
    broadcastRawBody(body) {
        return this.axios
            .post('/v2/bot/message/broadcast', body)
            .then((res) => res.data, handleError);
    }
    /**
     * Broadcast Message
    ...
    retrieveMessageContent(messageId) {
        (0, warning_1.default)(false, '`retrieveMessageContent` is deprecated. Use `getMessageContent` instead.');
    ...
    uploadRichMenuImage(richMenuId, image) {
        ...
        (0, ts_invariant_1.default)(type && (type.mime === 'image/jpeg' || type.mime === 'image/png'), 'Image must be `image/jpeg` or `image/png`');
        return this.dataAxios
    ...
    issueLinkToken(userId) {
        (0, warning_1.default)(false, '`issueLinkToken` is deprecated. Use `getLinkToken` instead. Note: It returns a string instead of an object.');
        return this.axios

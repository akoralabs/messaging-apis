...
class MessengerClient {
    ...
    sendMessage(psidOrRecipient, message, options = {}) {
        ...
        return this.sendRawBody(Object.assign({ messagingType,
            recipient, message: Messenger.createMessage(message, options) }, (0, omit_1.default)(options, 'quickReplies')));
    }
    /**
    ...
    sendAttachment(psidOrRecipient, attachment, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createAttachment(attachment, options), options);
    }
    /**
    ...
    sendText(psidOrRecipient, text, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createText(text, options), options);
    }
    /**
    ...
    sendTemplate(psidOrRecipient, payload, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createTemplate(payload, options), options);
    }
    /**
    ...
    sendButtonTemplate(psidOrRecipient, text, buttons, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createButtonTemplate(text, buttons, options), options);
    }
    /**
    ...
    sendGenericTemplate(psidOrRecipient, elements, options = {}) {
        return this.sendMessage(psidOrRecipient, Messenger.createGenericTemplate(elements, options), (0, omit_1.default)(options, ['imageAspectRatio']));
    }
    /**
    ...
    sendReceiptTemplate(psidOrRecipient, receipt, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createReceiptTemplate(receipt, options), options);
    }
    /**
    ...
    sendMediaTemplate(psidOrRecipient, elements, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createMediaTemplate(elements, options), options);
    }
    /**
    ...
    sendAirlineBoardingPassTemplate(psidOrRecipient, attrs, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createAirlineBoardingPassTemplate(attrs, options), options);
    }
    /**
    ...
    sendAirlineCheckinTemplate(psidOrRecipient, attrs, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createAirlineCheckinTemplate(attrs, options), options);
    }
    /**
    ...
    sendAirlineItineraryTemplate(psidOrRecipient, attrs, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createAirlineItineraryTemplate(attrs, options), options);
    }
    /**
    ...
    sendAirlineUpdateTemplate(psidOrRecipient, attrs, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createAirlineUpdateTemplate(attrs, options), options);
    }
    /**
     *
     * @param psidOrRecipient - A facebook page-scoped ID of the recipient or a recipient object
    ...
    sendOneTimeNotifReqTemplate(psidOrRecipient, attrs, options) {
        return this.sendMessage(psidOrRecipient, Messenger.createOneTimeNotifReqTemplate(attrs, options), options);
    }
    /**
